<template>
  <div class="hello grey-bg">
    ...
    <div class="container doc-container" id="doc-container">
      <div class="doc-title-box">
        ...
        <div class="tool-bar pull-right">
          ...
          <el-button type="text" @click="edit_page">{{$t('edit')}}</el-button>
          &nbsp;&nbsp;&nbsp;
          <el-dropdown>
    ...
    >
      ...
      <p><a href="javascript:;" class="home-phone-butt" v-clipboard:copyhttplist="copyText"
            v-clipboard:success="onCopy">{{$t('copy_link')}}</a></p>
      <div style="border-bottom: 1px solid #eee;width: 100px;margin: 0 auto" id="share_item_link"></div>
  ...
  export default {
    ...
    methods: {
      ...
      share_item() {
        ...
        var that = this
        this.$nextTick(() => {
          if (that.qr_item_link) {
            that.qr_item_link.clear()
            that.qr_item_link.makeCode(that.share_item_link);
          } else {
            that.qr_item_link = new QRCode("share_item_link", {
              text: that.share_item_link,
              width: 100,
              height: 100,
              colorDark: '#000000',
              colorLight: '#ffffff'
        ...
        this.copyText = this.share_item_link;
      },
      AdaptToMobile() {
    ...
    mounted() {
      const pages = this.item_info.pages;
