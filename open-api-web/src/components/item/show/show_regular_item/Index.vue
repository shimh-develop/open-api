  ...
  <div class="hello">
    <Header> </Header>
      ...
      <el-container>
                ...
                <router-link  to="/item/index" >{{$t('goback')}} </router-link>
                  ...
                  <span class="el-dropdown-link">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <router-link v-if="item_info.item_type === 1" :to="'/item/setting/'+item_info.item_id"><el-dropdown-item>{{$t('item_setting')}}</el-dropdown-item></router-link>
                    </el-dropdown-menu>
                  </el-dropdown>
              </div>
        ...
        <div class="page-bar" v-if="$login()" v-show="show_page_bar" >
