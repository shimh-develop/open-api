          ...
          <el-tabs value="first" type="card">
            ...
            <el-tab-pane :label="$t('modify_password')" name="first">
              ...
              <el-form status-icon label-width="0px" class="passwordForm" v-model="passwordForm">
                <el-form-item label="">
                  <el-input type="text" auto-complete="off" v-model="getUserName" placeholder=""
                            :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="">
                  <el-input type="password" auto-complete="off" :placeholder="$t('old_password')"
                            v-model="passwordForm.password"></el-input>
                </el-form-item>

                <el-form-item label="">
                  <el-input type="password" auto-complete="off" v-model="passwordForm.new_password"
                            :placeholder="$t('new_password')"></el-input>
                </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      passwordFormSubmit() {
        var that = this;
        var url = DocConfig.server + '/user/resetPassword';
        ...
        that.axios.post(url, params)
          .then(function (response) {
            if (response.data.error_code === 0) {
              ...
              that.$message.error(response.data.error_message);
            }
